...
const CreateCars = (() => {
  ...
  //  special cars
  const specialCars = cars.filter((auto) => auto.special === true);
          ...
          <div class="col-10 mx-auto my-3 col-md-6 col-lg-4 single-car ${car.country}">
            <div class="card car-card">
              ...
              <div class="card-footer text-capitalize d-flex justify-content-between">
                <p><span class="mr-2"><i class="fas fa-car"></i></span>${car.type}</p>
                <p><span class="mr-2"><i class="fas fa-cogs"></i></span>${car.trans}</p>
                <p><span class="mr-2"><i class="fas fa-gas-pump"></i></span>${car.gas}</p>
              </div>
            </div>
          </div>
          <!-- end of single car -->`;
...
const Gallery = (() => {
  ...
  galleryImg.forEach((item) => {
    item.addEventListener('click', () => {
      ...
      const img = fullPath.slice(position);
      modalImg.src = img;
    })
  });
})();